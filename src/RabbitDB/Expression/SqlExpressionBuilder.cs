...
namespace RabbitDB.Expression
{
    internal class ExpressionSqlBuilder<T>
    {
        ...
        //{
        //    _provider = provider;
        //    _typeMapping = TypeMapping.GetTypeMapping(typeof(T));
        ...
        //{
        //    _sb.AppendFormat(" from {0}", _provider.EscapeName(_typeMapping.Name));
        //    return this;
        //}
        ...
        //{
        //    var max = _typeMapping.Columns.Length;
        //    for (int i = 0; i < max; i++)
        //    {
        //        var c = _typeMapping.Columns[i];
        //        if (_typeMapping.Excludes.Contains(c)) continue;
        ...
        //{
        //    _sb.Append(_provider.EscapeName(_typeMapping.Name));
        //    return this;
        //}
