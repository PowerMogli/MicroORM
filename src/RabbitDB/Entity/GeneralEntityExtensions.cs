...
namespace RabbitDB.Entity
{
    ...
    {
        internal static Tuple<string, QueryParameterCollection> PrepareForUpdate<TEntity>(this TEntity entity, KeyValuePair<string, object>[] valuesToUpdate)
        {
        ...
        internal static Tuple<bool, string, QueryParameterCollection> PrepareForUpdate<TEntity>(this TEntity entity) where TEntity : Entity
        {
